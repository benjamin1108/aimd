...
export const tourMenuToggleEl = lazyEl<HTMLButtonElement>("#tour-menu-toggle");
export const tourMenuEl = lazyEl<HTMLElement>("#tour-menu");
export const tourStatusDotEl = lazyEl<HTMLElement>("#tour-status-dot");
