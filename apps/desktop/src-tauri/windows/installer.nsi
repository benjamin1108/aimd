; Copied from tauri-bundler v2.9.1:
; crates/tauri-bundler/src/bundle/windows/nsis/installer.nsi
;
; AIMD carries a small maintenance-uninstall patch in PageLeaveReinstall below.
; Keep this template in sync when upgrading Tauri's bundled NSIS template.
